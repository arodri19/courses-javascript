...
import { SaveSurveyResultParams, SaveSurveyResultRepository, SurveyResultModel } from '@/data/usecases/surveyResult/save-survey-result/db-save-survey-result-protocols'
