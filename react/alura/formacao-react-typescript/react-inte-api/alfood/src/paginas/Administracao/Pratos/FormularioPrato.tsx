            ...
            <Box sx={{ display: 'flex', flexDirection: "column", alignItems: "center", flexGrow: 1 }}>
                ...
                <Box component="form" sx={{width: '100%'}} onSubmit={aoSubmeterForm}>
                    ...
                    <FormControl margin="dense" fullWidth>
                        ...
                        <Select labelId="seletec-tag" value={tag} onChange={evento => setTag(evento.target.value)}>
                            {tags.map(tag => 
                    ...
                    <FormControl margin="dense" fullWidth>
                        ...
                        <Select labelId="seletec-restaurante" value={restaurante} onChange={evento => setRestaurante(evento.target.value)}>
